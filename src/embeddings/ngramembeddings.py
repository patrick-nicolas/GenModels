...
from embeddings.ngramembeddingsparams import NGramEmbeddingsParams
from embeddings.ngramcbowmodel import NGramCBOWModel
...
"""
    ...
    :param  List of valid words used as input to the embeddings
    :param ngrams_embeddings_params Configuration parameters for the embeddings
...
class NGramEmbeddings(PlotterMixin):
    def __init__(self,
        ...
        self.model_id = IOUtil.s3path_model_id(model_id)
        self.vocabulary = vocabulary
        self.load_snapshot = load_snapshot

    '''
        Generic method for training and evaluation 
        :param ngram_dataset Features,label data set for NGram embeddings
    '''
    ...
    def load(model_id: str) -> (nn.Embedding, int):
        ...
        # Step 1: Load the configuration attributes for the embeddings
        ...
        # Step 2: Load the weights for the embeddings
    ...
    def __split_data_loader(ngram_dataset: NGramDataset, is_split: bool) -> (NGramDataset, NGramDataset):
        ...
        IOUtil.log_info(f'Loaded {num_train_records} training and {num_val_records} validation records with {split_type} split')
    ...
    def __save(self, model: NGramCBOWModel, optimizer: optim.Adam):
        ...
        IOUtil.log_info(f'Save to {_model_path}')
