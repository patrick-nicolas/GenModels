...
from embeddings.embeddedngrams import EmbeddedNGrams
...
"""
    ...
    :param ngrams_embeddings_params Parameters for the embeddings
"""
...
class NGramCBOWModel(EmbeddedNGrams):
    ...
    def forward(self, input: torch.Tensor) -> float:
        ...
        # Flatten to match the size of the input tensor, then apply a soft max
