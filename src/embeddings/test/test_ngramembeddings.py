...
import constants
from embeddings.ngramembeddings import NGramEmbeddingsParams
from embeddings.ngramembeddings import NGramEmbeddings
...
class TestNGramEmbeddings(TestCase):
    def test_train_and_eval(self):
        try:
            ...
            s3_path = f'{constants.embedding_layer_s3_folder}/{data_source}/terms'

            context = Context(context_stride)
            limit = 8
            ngram_dataset = NGramDataset.init(constants.default_s3_bucket_name, s3_path, 'terms', context, limit)
