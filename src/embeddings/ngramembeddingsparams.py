...
"""
    Class that wraps the configuration parameters for the NGram embeddings
...
class NGramEmbeddingsParams(object):
    def __init__(self,
        ...
        assert 8 <= embedding_size <= 256, f'Size of embeddings {embedding_size} should be [16, 256]'
