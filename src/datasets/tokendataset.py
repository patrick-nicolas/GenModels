...
class TokenDataset(Dataset):
    ...
    '''
        ...
        :param feature_names: Name of column_names containing the features and label
        :param file_extension: Extension of the files from which the features and labels have to be extracted
        :returns: Dataset
    '''
    @classmethod
